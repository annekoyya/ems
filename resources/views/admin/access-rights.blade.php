...
<div x-data="grantAccess()" class="p-6 bg-blue-50 min-h-screen">
        ...
        <template x-for="emp in filteredEmployees" :key="emp.id">
          <tr class="border-b hover:bg-gray-50 transition">
            ...
            <td class="p-3 text-center">
              <button @click="openModal(emp)" class="text-blue-600 hover:text-blue-800 font-semibold">🔑 Grant</button>
            </td>
          </tr>
        </template>
      </tbody>
  ...
  >
    <div class="bg-white rounded-xl shadow-xl w-96 p-6 relative" @click.away="showModal = false">
      <button class="absolute top-3 right-3 text-gray-400 hover:text-gray-700" @click="showModal = false">✖</button>
