...
<head>
    ...
    <title>Employee View Profile - Blue Lotus</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group input, .form-group textarea { width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; background-color: #f8f9fa; color: #666; }
        .form-group input:disabled, .form-group textarea:disabled { background-color: #f8f9fa; cursor: not-allowed; }

        .btn-generate { background-color: #45AEE4; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; font-size: 14px; font-weight: 500; float: right; }
        .btn-generate:hover { background-color: #3a9cd1; }
        ...
        <main class="main-content">
            <div class="header">
                <div class="header-left">
                    ...
                    <h1>Employee Management / View Profile</h1>
                </div>
                <div class="user-info">
            ...
            <div class="form-container">
                <button onclick="window.location.href='{{ route('employees.pdf', $employee) }}'" class="btn-generate">Generate</button>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->middle_name }}" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->name_extension }}" disabled>
                        </div>
                    </div>
                    <div class="form-row two-cols">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->date_of_birth ? \Carbon\Carbon::parse($employee->date_of_birth)->format('d/m/Y') : 'N/A' }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <textarea rows="2" disabled>{{ $employee->home_address }}</textarea>
                        </div>
                    </div>
                    <div class="form-row two-cols">
                        <div class="form-group">
                            <label>Emergency Contact Name</label>
                            <input type="text" value="{{ $employee->emergency_contact_name }}" disabled>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row two-cols">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->emergency_contact_number }}" disabled>
                        </div>
                        <div class="form-group">
                            <label>Phone Number</label>
                            <input type="text" value="{{ $employee->phone_number }}" disabled>
                        </div>
                    </div>
                    <div class="form-row full">
                        <div class="form-group">
                            <label>Relationship</label>
                            <input type="text" value="{{ $employee->relationship }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->start_date ? \Carbon\Carbon::parse($employee->start_date)->format('d/m/Y') : 'N/A' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label>Job Position</label>
                            <input type="text" value="{{ $employee->job_category }}" disabled>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row two-cols">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->employment_type ?? 'Full time' }}" disabled>
                        </div>
                        <div class="form-group">
                            <label>Reporting Manager</label>
                            <input type="text" value="{{ $employee->reporting_manager }}" disabled>
                        </div>
                    </div>
                    <div class="form-row full">
                        <div class="form-group">
