...
<head>
    ...
    <title>Terminate Employee - Blue Lotus</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-terminate { background-color: #45AEE4; color: white; padding: 10px 30px; border: none; border-radius: 5px; cursor: pointer; font-size: 14px; font-weight: 500; }
        .btn-terminate:hover { background-color: #3a9cd1; }
        ...
        <main class="main-content">
            <div class="header">
                <div class="header-left">
                    ...
                    <h1>Employee Management / Terminate Profile</h1>
                </div>
                <div class="user-info">
            ...
            <form method="POST" action="{{ route('employees.terminate', $employee) }}" class="form-container">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $employee->first_name }} {{ $employee->middle_name }} {{ $employee->last_name }}" disabled>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <textarea name="termination_reason" rows="3" placeholder="Please provide detailed reason for termination. This information will be kept confidential and used only for internal HR records and future reference." required></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-option">
                                    <input type="radio" id="clearance_form" name="required_paperwork" value="Clearance Form" required>
                                    <label for="clearance_form">Clearance Form</label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="outstanding_advances" name="required_paperwork" value="Clearing Outstanding Advances">
                                    <label for="outstanding_advances">Clearing Outstanding Advances</label>
                                </div>
                            </div>
                        </div>
                    </div>
